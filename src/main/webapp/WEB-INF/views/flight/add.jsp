		...
		<div class="container-contact3">
			<div class="wrap-contact3">
				<form:form method="POST" action="/space.flights/flight/editsave"
					...
					<span class="contact3-form-title"> Add flight </span>
					...
					<div class="container-contact3-form-btn">
						<input type="submit" value="Add flight" class="contact3-form-btn" />
					</div>
				</form:form>
				<div class="container-contact3-form-btn">
					<form:form method="GET" action="/space.flights/flight/">
						<input type="submit" value="RETURN" class="contact3-form-btn" />
					</form:form>
				</div>
			</div>
		</div>
